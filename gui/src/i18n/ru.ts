...
"common.discard": "Отбросить",
 ...
 "logs.filter.conversation.clear": "Сбросить",
  ...
  // usage page
    "usage.retention.title": "Ограничение размера истории использования",
  "usage.retention.help": "При желании сохраняйте самые новые полные записи использования в пределах заданного размера. Старые строки автоматически удаляются, когда история превышает лимит.",
  ...
  "usage.retention.unlimited": "Без ограничений",
    "usage.retention.loadError": "Не удалось загрузить ограничение размера истории использования.",
