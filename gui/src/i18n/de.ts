...
"common.discard": "Verwerfen",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "debug.noLines.injection": "Injektions-Log ist an, aber es wurde noch nichts erfasst. Es erfasst Multi-Agent-Guidance-Injektion und Effort-Cap-Entscheidungen bei Collab- und Sub-Agent-Turns.",
    "usage.retention.title": "Größenlimit für Nutzungsverlauf",
  "usage.retention.help": "Optional können die neuesten vollständigen Nutzungsdatensätze innerhalb eines Größenlimits behalten werden. Ältere Einträge werden automatisch entfernt, sobald der Verlauf das Limit überschreitet.",
  ...
  "usage.retention.unlimited": "Unbegrenzt",
    "usage.retention.loadError": "Das Größenlimit für den Nutzungsverlauf konnte nicht geladen werden.",
